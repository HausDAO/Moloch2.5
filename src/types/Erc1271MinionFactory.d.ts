...
interface Erc1271MinionFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class Erc1271MinionFactory extends Contract {
  ...
  interface: Erc1271MinionFactoryInterface;
